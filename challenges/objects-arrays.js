...
const dinos = [
  ...
  {"name":"stegosaurus", "diet":"herbivorous", "weight": "2000kg", "length":"9m", "period": ""},
...
function tySays(phrase){
  return dinos[0].name + ` says ` + phrase;
}
console.log(tySays("RAWERSRARARWERSARARARRRR!"));
